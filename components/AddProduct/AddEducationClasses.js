  ...
  return (
    <>
        ...
        >
          ...
          <View style={modernStyles.header}>
            ...
            <View style={modernStyles.headerContent}>
              <Text style={modernStyles.headerTitle}>{subcategory?.name || 'Education Classes'}</Text>
              <Text style={modernStyles.headerSubtitle}>Add your class details</Text>
            </View>
          </View>
      ...
      <ModernSelectionModal
        ...
        title="Select Type"
        options={['Tutions', 'Hobby Classes', 'Skill Development', 'Others']}

  ...
  return (
    <>
        ...
        >
          ...
          <View style={modernStyles.header}>
            ...
            <View style={modernStyles.headerContent}>
              <Text style={modernStyles.headerTitle}>{subcategory?.name || 'Health & Beauty'}</Text>
      ...
      <ModernSelectionModal
        ...
        title="Select Type"
        options={['Fitness & Wellness', 'Salon Services', 'Health & Safety', 'Others']}
...
export default AddHealthBeauty;
        ...
        >
          ...
          <View style={modernStyles.header}>
            ...
            <View style={modernStyles.headerContent}>
              <Text style={modernStyles.headerTitle}>{subcategory?.name || 'Land & Plots'}</Text>
              <Text style={modernStyles.headerSubtitle}>Add your land details</Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={modernStyles.fieldContainer}>
              <View style={modernStyles.labelContainer}>
                ...
                <Text style={modernStyles.label}>Plot Area (ft²) *</Text>
              </View>
            ...
            <View style={modernStyles.fieldContainer}>
              <View style={modernStyles.labelContainer}>
                <Icon name="resize-outline" size={normalize(18)} color={labelIconColor} style={modernStyles.labelIcon} />
                <Text style={modernStyles.label}>Length (ft)</Text>
              </View>
              <View style={modernStyles.inputWrapper}>
                <TextInput
                  style={modernStyles.input}
            ...
            <View style={modernStyles.fieldContainer}>
              <View style={modernStyles.labelContainer}>
                <Icon name="resize-outline" size={normalize(18)} color={labelIconColor} style={modernStyles.labelIcon} />
                <Text style={modernStyles.label}>Breadth (ft)</Text>
              </View>
              <View style={modernStyles.inputWrapper}>
                <TextInput
                  style={modernStyles.input}

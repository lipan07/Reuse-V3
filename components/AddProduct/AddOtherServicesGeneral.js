...
const AddOtherServicesGeneral = ({ route, navigation }) => {
    const { category, subcategory, product } = route.params;
    const [formData, setFormData] = useState({
        type: 'Consultation', // Default to Consultation
        adTitle: '',
        description: '',
        address: '',
        latitude: null,
        ...
        const fetchProductDetails = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setFormData({
                        id: productData.id,
                        type: productData.type || 'Consultation',
    ...
    return (
        <>
            ...
            <ModernSelectionModal
                ...
                options={['Consultation', 'Maintenance', 'Repair', 'Installation', 'Others']}
...
export default AddOtherServicesGeneral;

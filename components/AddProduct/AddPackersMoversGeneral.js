...
const AddPackersMoversGeneral = ({ route, navigation }) => {
    const { category, subcategory, product } = route.params;
    const [formData, setFormData] = useState({
        type: 'Local Moving', // Default to Local Moving
        adTitle: '',
        description: '',
        address: '',
        latitude: null,
        ...
        const fetchProductDetails = async () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setFormData({
                        id: productData.id,
                        type: productData.type || 'Local Moving',
        ...
        <>
            ...
            >
                <View style={styles.formHeaderContainer}>
                    ...
                    <Text style={styles.formSubHeader}>Fill in details for your service</Text>
                </View>
                <ScrollView contentContainerStyle={styles.scrollViewContent} keyboardShouldPersistTaps="handled">
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
                        ...
                        <Text style={{ marginLeft: 10 }}>
                            Allow clients to contact me directly by phone
                        </Text>
                    </View>
                ...
                <View style={styles.stickyButton}>
                    ...
                    >
                        <Text style={styles.submitButtonText}>
                            {isSubmitting ? 'Processing...' : product ? 'Update Service' : 'Submit Service'}
                        </Text>
                    </TouchableOpacity>
                </View>
            </KeyboardAvoidingView>
            ...
            <ModernSelectionModal
                ...
                options={['Local Moving', 'Interstate Moving', 'Packing Services', 'Loading/Unloading', 'Others']}
                selectedValue={formData.type}
                onSelect={(value) => handleSelection('type', value)}
...
export default AddPackersMoversGeneral;

        ...
        >
          ...
          <View style={modernStyles.header}>
            ...
            <View style={modernStyles.headerContent}>
              <Text style={modernStyles.headerTitle}>{subcategory?.name || 'Scooter Listing'}</Text>
              <Text style={modernStyles.headerSubtitle}>Add your scooter details</Text>
            </View>
          </View>
            ...
            <View style={modernStyles.fieldContainer}>
              ...
              <View style={modernStyles.inputWrapper}>
                <TextInput
                  ...
                  placeholder="Describe your scooter..."
                  placeholderTextColor="#999"

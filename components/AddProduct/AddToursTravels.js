        ...
        >
          ...
          <View style={modernStyles.header}>
            ...
            <View style={modernStyles.headerContent}>
              <Text style={modernStyles.headerTitle}>{subcategory?.name || 'Tours & Travels'}</Text>
            ...
            <View style={modernStyles.fieldContainer}>
              ...
              >
                <Text style={modernStyles.selectButtonText}>
                  {formData.type ? formData.type.split('-').map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(' ') : 'Select Type'}
                </Text>
